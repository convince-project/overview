...
![initial_bt](imgs/refine_plan_tutorial_initial_bt.png)
...
From this, a tmux session will open with two panels:
The first one is for the simulation, and the second one is for execution.
The execution panel provides insights into the robot's decision-making.
...
![framework](imgs/refine_plan_framework.png)
